...
### 4. Storage fișiere
- Fișierele încărcate de clienți sunt salvate într-un storage de fișiere (S3 sau compatibil cu acesta, pentru rulare locala se poate folosi https://www.min.io/)
...
## Versiuni cheie ale aplicatiei:
  - v0.4: frontend, backend si baza de date, autentificare si autorizare, user management
  - v1.0: in plus apar photo management, inclusiv file storage, si serviciul de ocr apelat prin endpoint
  - v1.1: serviciul de ocr este apelat prin intermediul unei cozi de mesaje RabbitMQ 
